 ...
 *
 */
public class DocumentProducer extends MessageProducer {

  /**
   * @param env
   */
  public DocumentProducer(IEnvironment env, String clientId) {
  ...
  public void sendMessage(String topic, String message, String key, Integer partition) {
    environment.logDebug("DocumentProducer "+message);
